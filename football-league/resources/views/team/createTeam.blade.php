      ...
      <div class=" md:grid-cols-1">
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-black ">
          ...
          <blockquote class="max-w-2xl mx-auto mb-4  lg:mb-8 text-gray-400">
            ...
            <h3 class="text-5xl font-semibold text-white">Create team</h3>
      ...
      <form action="{{route('storeteam')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid md:grid-cols-1 mx-96  mt-24 md:gap-6">
          <div class="relative z-0 w-full mb-6 group">
              <input type="text" name="team_name" id="team_name" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 text-gray-400 border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          ...
          <div class="relative z-0 w-full mb-6 group">
              <input type="text" name="team_dt" id="team_dt" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 text-gray-400 border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="grid md:grid-cols-1 mx-96  md:gap-6">
          <div class="relative z-0 w-full mb-6 group">
              <input type="text" name="team_stadium" id="team_stadium" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 text-gray-400 border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          ...
          <div class="relative z-0 w-full mb-6 group ">
              ...
              <input class="block w-full font-medium text-sm  rounded-lg cursor-pointer text-gray-200 focus:outline-none bg-gray-900 border-gray-600 "  name="team_img"  id="team_img" type="file">
