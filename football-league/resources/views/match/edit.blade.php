    ...
    <body class="bg-black ">
      ...
      <!-- title -->
        ...
        <figure class="flex flex-col items-center justify-center p-8 text-center bg-black ">
          ...
          <blockquote class="max-w-2xl mx-auto mb-4 lg:mb-8 text-gray-400">
            ...
            <h3 class="text-5xl font-semibold text-white">Edit Match</h3>
      ...
      <!-- form -->
        ...
        <form action="{{route('updatematch', $game->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <!--  goal team 2 -->
            <div class="relative z-0 w-full mb-6 group">
              <input type="text" name="goalsteam2" value="{{old('goalsteam2', $game->goals_Team2)}}" id="goalsteam2" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 text-gray-400 border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          ...
          <!-- select stadium -->
            <div class="relative z-0 w-full mb-6 group">
              <input type="text" name="matchstadium" value="{{old('matchstadium', $game->stadium)}}" id="matchstadium" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 text-gray-400 border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          ...
          <!-- date -->
            <div class="relative mb-6 flex group">
              ...
              <input datepicker name="matchdate" type="date" value="{{old('matchdate', $game->date)}}" class=" border  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 bg-black border-gray-600 placeholder-black text-gray-400 focus:ring-blue-500 focus:border-blue-500" placeholder="matchdate">
            </div>
          ...
          <!-- time -->
            <div class="relative mb-6 flex group">
              ...
              <input datepicker name="matchtime"  type="time" value="{{old('matchtime', $game->time)}}" class=" border  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 bg-black border-gray-600 placeholder-black text-gray-400 focus:ring-blue-500 focus:border-blue-500" placeholder="matchtime">
            </div>
