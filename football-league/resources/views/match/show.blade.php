...
<div class="grid grid-cols-1 p-8 ">
  <div class="flex justify-around m-20">
    ...
    <a href="{{route('updatematch', $game->id)}}" type="button" class="text-white bg-blue-500 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-500 dark:hover:bg-blue-800 dark:focus:ring-blue-900">Modify</a>
  </div>
</div>
