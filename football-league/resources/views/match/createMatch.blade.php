...
<h3 class="text-5xl font-semibold text-gray-900 dark:text-white">Create Match</h3>
...
<form action="{{route('storematch')}}" method="POST" enctype="multipart/form-data ">
  ...
  <!-- select 1 -->
    ...
    <label for="team1" class="block mb-2 text-sm text-gray-900 bg-transparent  dark:text-gray-400 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">Choose team 1</label>
    <select id="team1" name="team1"  class="bg-black border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-black dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500">
 ...
 <div class="relative z-0 w-full mb-6 group">
        <input type="text" name="goalsteam1" id="goalsteam1" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
...
<!-- select 2 -->
    ...
    <label for="team2" class="block mb-2 text-sm text-gray-900 bg-transparent  dark:text-gray-400 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">Choose team 2</label>
    <select id="team2" name="team2" class="bg-black border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-black dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500">
    <option selected></option>
 ...
 <div class="relative z-0 w-full mb-6 group">
        <input type="text" name="goalsteam2" id="goalsteam2" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
...
<!-- select stadium -->
    <div class="relative z-0 w-full mb-6 group">
        <input type="text" name="matchstadium" id="matchstadium" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
...
<div class="relative mb-6 flex group">
  ...
  <input datepicker name="matchtime"  type="time" class="bg-black border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-black dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="matchtime">
</div>
